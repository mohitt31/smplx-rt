...
int main() {
  constexpr int warmup=100, samples=1000; smplxrt::Frame frame{1280,720,std::vector<std::uint8_t>(1280*720*3,128)}; smplxrt::Pipeline pipeline; std::vector<double> times;
